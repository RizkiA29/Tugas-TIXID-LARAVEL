...
@section('content')
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-end">
            ...
            <a href="{{ route('admin.movies.create') }}" class="btn btn-success me-2">Tambah Film</a>
            <a href="{{ route('admin.movies.trash') }}" class="btn btn-danger me-2">Sampah</a>
        </div>
...
@push('script')
    <script>
        ...
        function showModal(item) {
            ...
            let content = `
    <img src="${image}" width="120px" class="d-block mx-auto my-3"/>
    <ul>
