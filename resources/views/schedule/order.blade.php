...
<div class="fixed-bottom w-100 p-2 text-center text-white" style="background: #112646" onclick="createQrcode()">
    <b>Bayar Sekarang</b>
</div>
@endsection
    ...
    function createQrcode() {
        ...
        $.ajax({
            ...
            error: function(message) {
                alert('Gagal membuat qrcode pembayaran, silakan coba lagi.');
            }
        });
    }
</script>
